          ...
          <div class=""style="padding-left :300px; padding-right :300px;">
            ...
            <form action="register.php" method="post" class="p-4 border rounded" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="company-website-tw d-block">Upload Resume:_________</label>
                <label class="btn btn-primary btn-md-12 btn-file">Browse File<input type="file" name="my_image" id="my_image" required>
                </label>
              </div>
              ...
              <p><a href="sign1.php"><span class="text-black"><u><strong>Register as Employer ?</strong></u></span></a></p>
