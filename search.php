...
<div class="site-wrap">
    ...
    <!-- HOME -->
    <section class="home-section section-hero overlay bg-image" style="background-image: url('images/back2.jpg');" id="home-section">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            ...
            <form method="post" class="search-jobs-form" action="search.php" enctype="multipart/form-data">
              <div class="row mb-5">
...
if($conn->connect_error){
    ...
    $insert="select * from `postjob` where CompanyName='$company' or JobType='$jobtype' or JobRegion='$region'";
    ...
    //    move_uploaded_file($image_tmp_name, $image_folder);
       ...
       <td>'.$row['JobType'].'</td>
       <td>'.$row['JobRegion'].'</td>
       <td><a href="apply.php">'.$row['Apply'].'</a></td>
       </tr>
       </tbody>';
       }
      }
...
?>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2">20,000 Job Listed</h2>
          </div>
        </div>
