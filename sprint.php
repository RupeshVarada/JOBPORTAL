    ...
    <section class="site-section">
      <div class="container">
            ...
            <div class="d-flex align-items-center">
              ...
              <div>
                ...
                <div>
                  ...
                  <span class="m-2"><span class="icon-room mr-2"></span>New Delhi</span>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="images/sprint.jpeg" alt="Image" class="img-fluid rounded"></figure>
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-align-left mr-3"></span>Job Description</h3>
              <p>Digital Marketing Directors are generally responsible for planning, developing, implementing and managing the overall digital marketing strategy</p>
              <p> Digital marketing director
                Demonstrable experience in designing and implementing successful digital marketing campaigns
                Strong understanding of how all current digital marketing channels function</p>
            </div>
            <div class="mb-5">
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-rocket mr-3"></span>Responsibilities</h3>
              <ul class="list-unstyled m-0 p-0">
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Build, plan and implement the overall digital marketing strategy</span></li>
                ...
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Manage the strategy</span></li>

                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Manage and train the rest of the team</span></li>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Experience:</strong> 5 to 9 year(s)</li>
                <li class="mb-2"><strong class="text-black">Job Location:</strong> New Delhi</li>
                <li class="mb-2"><strong class="text-black">Salary:</strong> 12 lpa</li>
