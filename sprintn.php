...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">SPRINT</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php">Home</a> <span class="mx-2 slash">/</span>
              <a href="#">Job</a> <span class="mx-2 slash">/</span>
              <a href="job-single.php">Job Offers</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Sprint</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section">
      <div class="container">
          ...
          <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="d-flex align-items-center">
              <div class="border p-2 d-inline-block mr-3 rounded">
                <img src="images/job_logo_2.jpg" alt="Image">
              </div>
              <div>
                <h2>Marketing Executive</h2>
                <div>
                  <span class="ml-0 mr-2 mb-2"><span class="icon-briefcase mr-2"></span>Sprint</span>
                  <span class="m-2"><span class="icon-room mr-2"></span>Noida</span>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="images/sprintn.webp" alt="Image" class="img-fluid rounded"></figure>
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-align-left mr-3"></span>Job Description</h3>
              <p>Marketing executives are usually part of a larger marketing team whose aim is to raise awareness of new products, brands and services via campaigns and projects.</p>
              <p> Executives tend to be involved in practical rather than strategic ways but they’re often involved in multiple aspects of a campaign. As a result, they’re likely to have a lot of responsibility and need to juggle many priorities.</p>
            </div>
            <div class="mb-5">
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-rocket mr-3"></span>Responsibilities</h3>
              <ul class="list-unstyled m-0 p-0">
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>contributing ideas to marketing campaigns.</span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>conducting research and analysing data to identify and define audiences</span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>compiling, distributing and presenting ideas, information and strategies</span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>coordinating promotional activities, events and interviews</span></li>
              </ul>
            </div>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Job Location:</strong> Noida</li>
                <li class="mb-2"><strong class="text-black">Salary:</strong> 3.5 to 4.5 lpa</li>
