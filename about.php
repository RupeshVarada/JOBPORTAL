...
<div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="section-title mb-3">JobPortal For Companies</h2>
            <p class="lead">Job portals provide a centralized location for employers to post information about job openings. </p>
            <p>The majority of employment portals require a fee for employers to post job openings and respond to resumes, with varying terms depending on the job portal. But it varies with us</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            ...
            <p class="lead">A job portal is a website dedicated for online information about recruiters as well as job seekers.</p>
            <p> A job portal helps both the job seekers and recruiters finding the right organization for the employees.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row align-items-center block__69944">
          ...
          <div class="col-md-6">
            <img src="images/chinmay.jpg" alt="Image" class="img-fluid mb-4 rounded">
          </div>

          <div class="col-md-6">
            <h3>Chinmay Chintala</h3>
          ...
          <div class="col-md-6 order-md-2 ml-md-auto">
            <img src="images/diana.jpg" alt="Image" class="img-fluid mb-4 rounded">
          </div>

          <div class="col-md-6">
            <h3>Diana Javadala</h3>
            <p class="text-muted">Front End Developer</p>
            <!-- <p>Soluta quasi cum delectus eum facilis recusandae nesciunt molestias accusantium libero dolores repellat id in dolorem laborum ad modi qui at quas dolorum voluptatem voluptatum repudiandae voluptatibus ut? Ex vel  ad explicabo iure ipsa possimus consectetur neque rem molestiae eligendi velit?.</p> -->
            <div class="social mt-4">
              <a href="#"><span class="icon-facebook"></span></a>
      ...
      <div class="row align-items-center block__69944">
        ...
        <div class="col-md-6">
          <img src="images/rupesh1.jpg" alt="Image" class="img-fluid mb-4 rounded">
        </div>
        ...
        <div class="col-md-6 order-md-2 ml-md-auto">
          <img src="images/rohit.jpg" alt="Image" class="img-fluid mb-4 rounded">
        </div>

        <div class="col-md-6">
          <h3>Rohit Sree Vanamoju</h3>
          <p class="text-muted">Back End Developer</p>
          <!-- <p>Soluta quasi cum delectus eum facilis recusandae nesciunt molestias accusantium libero dolores repellat id in dolorem laborum ad modi qui at quas dolorum voluptatem voluptatum repudiandae voluptatibus ut? Ex vel  ad explicabo iure ipsa possimus consectetur neque rem molestiae eligendi velit?.</p> -->
          <div class="social mt-4">
            <a href="#"><span class="icon-facebook"></span></a>
  ...
  <div class="row align-items-center block__69944">
    ...
    <div class="col-md-6">
      <img src="images/sathish.jpg" alt="Image" class="img-fluid mb-4 rounded">
    </div>
