...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">MICROSOFT</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php">Home</a> <span class="mx-2 slash">/</span>
              <a href="#">Job</a> <span class="mx-2 slash">/</span>
              <a href="job-single.php">Job Offers</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>MICROSOFT</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section">
      <div class="container">
          ...
          <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="d-flex align-items-center">
              <div class="border p-2 d-inline-block mr-3 rounded">
                <img src="images/job_logo_4.jpg" alt="Image">
              </div>
              <div>
                <h2>Senior Art Director</h2>
                <div>
                  <span class="ml-0 mr-2 mb-2"><span class="icon-briefcase mr-2"></span>Microsoft</span>
                  <span class="m-2"><span class="icon-room mr-2"></span>Anywhere</span>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="images/microsoft.jpg" alt="Image" class="img-fluid rounded"></figure>
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-align-left mr-3"></span>Job Description</h3>
              <p>A senior art director is responsible for monitoring the creative art department's operations, ensuring the adequacy of resources and materials, as well as high-quality outputs based on clients' specifications and business requirements. </p>
              <p>Senior art directors implement strategic project management procedures to offer deliverables within the budget goals and set timeframe. They coordinate with the clients for progress updates and inform them of any adjustments as needed</p>
            </div>
            <div class="mb-5">
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-rocket mr-3"></span>Responsibilities</h3>
              <ul class="list-unstyled m-0 p-0">
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Design, implement, and manage online marketing programs focusing on building awareness and customer acquisition.</span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Direct and manage all photography including composition, talent acquisition and photo manipulation.</span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Lead art director on RFP and new business pitches.</span></li>
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>Manage and direct interaction designers, marketing designers, HTML production and user research teams.</span></li>
              </ul>
            </div>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Experience:</strong> 9 to 10 year(s)</li>
                <li class="mb-2"><strong class="text-black">Job Location:</strong> Anywhere</li>
                <li class="mb-2"><strong class="text-black">Salary:</strong> 50 lpa - 100 lpa</li>
