            ...
            <div class="d-flex align-items-center">
              ...
              <div>
                ...
                <div>
                  ...
                  <span class="m-2"><span class="icon-room mr-2"></span>Hyderabad,Telangana</span>
                  <span class="m-2"><span class="icon-clock-o mr-2"></span><span class="text-primary">Part Time</span></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                ...
                <li class="mb-2"><strong class="text-black">Job Location:</strong> Hyderabad</li>
