        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="custom-breadcrumbs">
              ...
              <a href="sign1.php"><span class="text-white"><strong>Sign up</strong></span></a><span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Employer Sign up</strong></span>
      ...
      <div class="container">
        <div class="row">
          <div class=""style="padding-left :300px; padding-right:300px;">
            ...
            <form action="eregister.php"  method="post" class="p-4 border rounded"  enctype="multipart/form-data">

              <div class="row form-group">
                <h4>About your company</h4>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Company Name *</label>
                  <input type="text" id="fname" class="form-control" placeholder="Company Name" name="company" required>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Contact Person Name</label>
                  <input type="text" id="fname" class="form-control" placeholder="contact Person Name" name="contact" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Job Address</label>
                  <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                    <textarea class="input_textarea__aM_Wl" placeholder="" rows="2" tabindex="0" name="jobAddress" maxlength="350" required></textarea>
                  </div>  
                    <p class="text-11 text-gray-primary ">Please fill complete address, mention Landmark near your office</p>                
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Submit" name="sendemp" class="btn px-4 btn-primary text-white">
                </div>
              </div>
              <p><a href="sign.php"><span class="text-black"><strong><u>Register as Job Seeker ?</u></strong></span></a></p>
            </form>
          </div>
          <!--<div class="col-lg-6">
