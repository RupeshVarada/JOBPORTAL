        ...
        <div class="row">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="#" class="block__16443 text-center d-block">
              ...
              <p>long-term plan for achieving a company's goals by understanding the needs of customers and creating a distinct and sustainable competitive advantage.</p>
            </a>            
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="#" class="block__16443 text-center d-block">
              ...
              <h3>SEO</h3>
              <p> identify strategies, techniques and tactics to increase the number of visitors to a website and obtain a high-ranking placement in the results page of search engines.</p>
            </a>
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="#" class="block__16443 text-center d-block">
              ...
              <p>person who shows interest in a brand's products or services, which makes the person a potential customer.</p>
            </a>
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="#" class="block__16443 text-center d-block">
              ...
              <p class="d-sm-block">design maximizes sharpness and is implemented to deliver maximum fidelity in the actual product.</p>
            </a>
